...
insert into usuario (nome,user,senha,status_user,email) values("bob","@cleiton","teste","Online","dog@auau");
...
insert into administrador(nome,senha,email,cpf,data_contratacao) values ("danieladm","senhaforte","daniel@adm","00111122233","2001-04-13 08:04:02");
insert into administrador(nome,senha,email,cpf,data_contratacao) values ("gabsadm","senhaforte","gabs@adm","00211122233","2001-04-13 08:04:02");
insert into administrador(nome,senha,email,cpf,data_contratacao) values ("euadm","senhaforte","eu@adm","00411122233","2001-04-13 08:04:02");
insert into administrador(nome,senha,email,cpf,data_contratacao) values ("tuadm","senhaforte","tu@adm","00511122233","2001-04-13 08:04:02");
insert into administrador(nome,senha,email,cpf,data_contratacao) values ("maisadm","senhaforte","plus@adm","00611122233","2001-04-13 08:04:02");
...
insert into Biblioteca(nome_no_jogo,id_jogo,id_usuario) values ("@dan","1","4");
insert into Biblioteca(nome_no_jogo,id_jogo,id_usuario) values ("@dan","2","4");
insert into Biblioteca(nome_no_jogo,id_jogo,id_usuario) values ("@dan","3","4");
insert into Biblioteca(nome_no_jogo,id_jogo,id_usuario) values ("@dan","4","4");
insert into Biblioteca(nome_no_jogo,id_jogo,id_usuario) values ("@dan","5","4");
...
call conquista("Teste campeao 2","1","1","1");
call conquista("Teste campeao 3","1","1","1");
call conquista("Teste campeao 4","1","1","1");
call conquista("Teste campeao 5","1","1","1");
